...
package com.microfish.it.account.login.authentication.pac4j.platform.qq;
...
public class Pac4jQQClientProperties extends Pac4jOAuth20ClientProperties {
    ...
    public Pac4jQQClientProperties() {
        setProfileVerb("GET");

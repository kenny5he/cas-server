...
package com.microfoolish.it.sso.account.configuration.processer;
...
import com.microfoolish.it.sso.account.configuration.annotation.ConfigurationPropertiesMapping;
...
public class CasPropertyMappingPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        Set<?> components = scanner.findCandidateComponents("com.micorfish.it.account.cas.config");

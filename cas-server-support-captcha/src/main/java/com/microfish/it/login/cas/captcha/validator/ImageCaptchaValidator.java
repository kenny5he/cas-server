...
package com.microfish.it.login.cas.captcha.validator;
 ...
 * @since 2022/07/26
 */
public class ImageCaptchaValidator extends BaseCaptchaValidator {

    public ImageCaptchaValidator(GoogleRecaptchaProperties recaptchaProperties) {

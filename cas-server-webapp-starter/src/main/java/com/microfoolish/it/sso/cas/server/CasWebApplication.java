...
public class CasWebApplication implements CasWebApplicationReadyListener {
    ...
    public static void main(final String[] args) {
        org.apereo.cas.CasEmbeddedContainerUtils.getLoggingInitialization().ifPresent(init -> init.setMainArguments(args));
        val banner = org.apereo.cas.CasEmbeddedContainerUtils.getCasBannerInstance();
        new SpringApplicationBuilder(org.apereo.cas.web.CasWebApplication.class)
                .banner(banner)

package com.microfoolish.it.sso.cas.server.tomcat;
...
public class CasTomcatServletWebServerFactoryCustomizer extends ServletWebServerFactoryCustomizer {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(CasTomcatServletWebServerFactoryCustomizer.class);
